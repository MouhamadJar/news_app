...
import 'package:news_app/view/home/trips/trip_details.dart';
                ...
                children: [
                  Row(
                    children: [
                      ...
                      showText(
                          text: 'Trip name', textColor: kBlack, size: 16.0),
                    ],
                  ),
                ],
              ),
            ),
            openBuilder: (context,action)=> TripDetails(tag: 'tag $index', title: 'Trip name', image: 'assets/trips.png'),
