...
class CategoryNews extends StatelessWidget {
   CategoryNews({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Get.to(()=>NewsDetails(tag: 'tag', title: 'News title', image: 'assets/news.png',),);
                },
                child: Hero(
                  tag: 'tag',
                  child: Container(
                    ...
                    child: Container(
                      ...
                      child: Center(child: showText(
                          text: 'News title'.tr, textColor: kWhite, size: 12)),
                    ),
                  ),
                ),
              ),
              SizedBox(
                ...
                child: ListView.separated(
                  itemBuilder: (context, index) =>
                    GestureDetector(
                      onTap: (){
                        Get.to(()=>NewsDetails(tag: 'tag $index', title: 'News title', image: 'assets/news.png',),);
                      },
                      child: Hero(
                        tag: 'tag $index',
                        child: Container(
                          height: height * .23,
                          width: width * .4,
                          padding: EdgeInsets.only(bottom: height*.063),
                          margin: EdgeInsets.symmetric(
                              horizontal: width * .02, vertical: height * .015),
                          decoration: BoxDecoration(
                            color: kGrey,
                        ...
                        child: Hero(
                          ...
                          child: Container(
                            ...
                            decoration:const BoxDecoration(
                              ...
                              color: kWhite,
                              image: DecorationImage(
                                  image: AssetImage('assets/real madrid.png'),
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  itemBuilder: (context, index) => GestureDetector(
                    onTap:  (){
                      Get.to(()=>NewsDetails(tag: 'tag $index 1', title: 'News title', image: 'assets/news.png',),);
                    },
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          showText(
                              text: 'News title'.tr, textColor: kBlack, size: 12.0),
                        ],
                      ),
                    ),
                  ),
