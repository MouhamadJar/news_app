...
import 'package:news_app/view/home/services_for_sport/services.dart';
import 'package:news_app/view/home/trips/trips.dart';
import '../../../controllers/home_controller.dart';
import '../../../models/components/components.dart';
import '../../../models/components/constants.dart';
import '../home_screen.dart';

class TripsCategory extends StatelessWidget {
  TripsCategory({Key? key}) : super(key: key);
          ...
          itemBuilder: (context, index) => OpenContainer(
            ...
            closedBuilder: (context, action) => Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: const [
                  BoxShadow(color: kGrey, blurRadius: 5, offset: Offset(0, 1)),
                ],
              ),
              height: height * .09,
              width: width,
            ...
            openBuilder: (context, action) => Trips(),
