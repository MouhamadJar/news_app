...
class ConditionsForObtainingMembership extends StatelessWidget {
  const ConditionsForObtainingMembership({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: ReadMoreText(
                conditionsForObtainingMembership,
                trimLines: 9,
