...
class IfmisNewsDetails extends StatefulWidget {
  const IfmisNewsDetails(
  ...
  @override
  State<IfmisNewsDetails> createState() => _IfmisNewsDetailsState();
}

class _IfmisNewsDetailsState extends State<IfmisNewsDetails> {
  bool isLiked = false;
  ...
  void initState() {
    _controller = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId("https://www.youtube.com/watch?v=SjODmV_UZig").toString(),
